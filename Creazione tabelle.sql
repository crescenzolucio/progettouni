...
/*TRIGGERS*/
/*CONTROLLO SALA*/
CREATE OR REPLACE FUNCTION CONTROLLO_SALA_PIENA() RETURNS TRIGGER AS $$
DECLARE
   POSTI_SALA INT;
...
ON BIGLIETTI
FOR EACH ROW
EXECUTE PROCEDURE CONTROLLO_SALA_PIENA();


/*CONTROLLO PROIEZIONE*/
CREATE OR REPLACE FUNCTION CONTROLLO_SALA_FILM_ORARIO() RETURNS TRIGGER AS $$
DECLARE
   CONTA INT := 0;
...
ON PROIEZIONI
FOR EACH ROW
EXECUTE PROCEDURE CONTROLLO_SALA_FILM_ORARIO();